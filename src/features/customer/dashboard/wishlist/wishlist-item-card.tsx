...
const WishlistItemCard = ({
    ...
    return (
        <div className="flex items-start gap-3 sm:gap-4">
            ...
            <div className="flex flex-col gap-2 w-28 sm:w-32 md:w-36 shrink-0">
                <Button
                    onClick={() => onAddToCart(item.id)}
                    className="bg-[#B5894A] text-white text-[8px] sm:text-[10px] md:text-xs font-medium py-2 sm:py-2.5 hover:bg-[#a07840] transition"
                >
                    Add to Cart
                </Button>
                <Button
                    onClick={() => onBuyNow(item.id)}
                    className="bg-[#262626] text-white text-[8px] sm:text-[10px] md:text-xs font-medium py-2 sm:py-2.5 hover:bg-[#171717] transition"
                >
                    Buy Now
                </Button>
            </div>
