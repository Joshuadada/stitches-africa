    ...
    return (
        <div className="px-4 sm:px-8 md:px-12 lg:px-16 xl:px-20 py-4 sm:py-6 md:py-8 lg:py-10 xl:py-13 flex flex-col gap-10 sm:gap-14 md:gap-18 lg:gap-22">
            ...
            <div className='flex justify-center'>
                <Button onClick={() => router.push('/trending')} type='submit' className='bg-transparent py-1.5 px-3.5 max-w-[138] w-full border border-[#A3A3A3] rounded-md flex items-center gap-2'>
