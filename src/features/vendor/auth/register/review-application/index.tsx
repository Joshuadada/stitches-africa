...
import { useSubmitVendorRegister } from '@/hooks/api/vendor/useVendorAuth'
...
const ReviewApplication = () => {
    ...
    const { onSubmit, isPending } = useSubmitVendorRegister((vendorId: string) => {
    ...
    const handleCopyReference = async () => {
        try {
            ...
            showToast({
                ...
                message: "You've successfully copied the reference ID!",
            });
        } catch (error) {
