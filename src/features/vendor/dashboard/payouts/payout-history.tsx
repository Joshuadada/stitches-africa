    ...
    return (
        <div className="overflow-hidden">
            ...
            <div className="overflow-x-auto">
                <table className="w-full min-w-[850] mx-2.5 sm:mx-3.5 md:mx-4.5 lg:mx-5.5">
                    <thead>
                    ...
                    <tbody>
                        {payouts.map((payout, index) => (
                            ...
                            >
                                <td className="pt-2 sm:pt-4 md:pt-6 lg:pt-7 pb-2 lg:pb-2.5 font-garamond text-[10px] sm:text-xs md:text-sm lg:text-base font-semibold text-black">
                                    {payout.date}
                                </td>

                                <td className="pt-2 sm:pt-4 md:pt-6 lg:pt-7 pb-2 lg:pb-2.5 text-black text-[8px] sm:text-[10px] md:text-xs lg:text-sm">
                                    {payout.gross}
                                </td>
                                ...
                                <td className="pt-2 sm:pt-4 md:pt-6 lg:pt-7 pb-2 lg:pb-2.5 text-[#1D9E75] text-[8px] sm:text-[10px] md:text-xs lg:text-sm font-bold">
                                    {payout.netPayout}
                                </td>
