        ...
        <div>
          <div>
            ...
            <div className="flex flex-col gap-1 md:gap-1.5 lg:gap-2 px-3 sm:px-5 md:px-7 lg:px-9 py-2 sm:py-3 md:py-3.5 lg:py-4 border-y border-[#FAF7F2]/30">
              ...
              <div className="flex">
                <p className="text-[10px] md:text-xs lg:text-sm text-[#92400E] font-bold bg-[#FEF3C7] px-4 md:px-5 lg:px-6 py-1 md:py-1.5 lg:py-2 border border-[#F59E0B] rounded-[20px]">Gold tier</p>
              </div>
            </div>
          </div>
